...
public:
  ...
  bool OnInitialize(HWND hWnd, LPTSTR /*lpCmdLine*/) {
    ...
    bool result = LoadTexture(_T("door128.tga"), &m_texture1);
    result &= LoadTexture(_T("fire128.tga"), &m_texture2);
  ...
  void OnKeyDown(WPARAM /*wp*/) { ASSERT(false); }
