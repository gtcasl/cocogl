...
public:
  ...
  bool OnInitialize(HWND hWnd, LPTSTR /*lpCmdLine*/) {
    ...
    static const float fogTypes[] = {GL_EXP, GL_EXP2, GL_LINEAR};
    ...
    static_assert(sizeof(_texCoords) == sizeof(texCoords), "invalid size");
    ...
    if (!LoadTexture(_T("block.tga"), &m_texture)) {
      return false;
    }
